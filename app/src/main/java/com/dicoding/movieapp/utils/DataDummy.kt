...
object DataDummy {
    ...
    fun createDataMovieDummy(): List<DataModel> {
    ...
    fun createDataTvShowDummy(): List<DataModel> {
        ...
        listTvShow.add(
            DataModel(
                ...
                description = "Martial law is declared when a mysterious viral outbreak pushes Korea into a state of emergency. Those on an express train to Busan, a city that has successfully fended off the viral outbreak, must fight for their own survival",
                poster = "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/3H1WFCuxyNRP35oiL2qqwhAXxc0.jpg",
                imgPreview = "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/3H1WFCuxyNRP35oiL2qqwhAXxc0.jpg"
            )
        )
