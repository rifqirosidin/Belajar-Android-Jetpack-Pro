    ...
    fun createDataMovieDummy(): List<DataModel> {
        ...
        listMovie.add(
            DataModel(
                ...
                img_preview = "https://image.tmdb.org/t/p/original/xcaSYLBhmDzJ6P14bcKe0KTh3QV.jpg"
            )
        )
    ...
    fun createDataTvShowDummy(): List<DataModel> {
        ...
        listTvShow.add(
            DataModel(
                ...
                img_preview = "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/3H1WFCuxyNRP35oiL2qqwhAXxc0.jpg"
            )
        )
